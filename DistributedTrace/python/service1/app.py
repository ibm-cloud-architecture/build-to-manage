...
appname = 'service1'
service2_url = 'https://service2-departmental-paleozoology.eu-gb.mybluemix.net/service'
...
@app.route("/service")
def service():
  # Include the transactionID in header for further calls
  headers = {'transactionID': get_transactionID('')}

  logger.info('Got a request with transactionID %s. Now calling Service2' % get_transactionID('') )
  r = requests.get(service2_url, headers=headers)
  logger.info('Got response from Service2')
