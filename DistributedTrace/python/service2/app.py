...
appname = 'service2'
service3_url = 'https://service3-macular-overacceleration.eu-gb.mybluemix.net/service'
...
def service():
  ...
  logger.info('Got a request with transactionID %s. Now calling Service3' % get_transactionID('') )
  r = requests.get(service3_url, headers=headers)
  logger.info('Got response from Service3')
